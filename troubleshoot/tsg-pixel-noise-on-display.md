...
* Usually it will be a single color. It very often happens with the GREEN component of a pixel, but it can happen with RED (LESS COMMON) or BLUE (UNCOMMON).
...
* If you are unable to resolve it, contact your manufacturer's support.
