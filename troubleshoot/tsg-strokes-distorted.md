...
To solve this, use Force Proportions in the tablet driver: [Matching aspect ratios with Force Proportions](../guides/customizing/force-proportions.md)

### What about distortion on Android?

Note for Android tablet users: Whether this distortion happens depends on the specific combination of drawing tablet, Android device, and Android version. There is no tablet driver to help fix the problem if it does occur.
...
For a pen tablet, I generally recommend turning on Force Proportions even if you do not notice the distortion, because I've seen a lot of tablets that don't match your display aspect ratio by just a little bit. The distortion is still happening, and you may not notice it visually, but it may still feel a bit weird to draw with.
