...
>
> Use the reverse side of the Pro Pen 2’s nib to reset the tablet. Insert the reversed nib straight into the hole and press firmly until you feel the reset button depress.
>
> Hold for 10–15 seconds until the power light on the tablet turns off, then release.
>
> Once released, the tablet will turn back on, and the tablet memory will be reset to default.
