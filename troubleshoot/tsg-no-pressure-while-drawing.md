...
Try the [**Common drawing troubleshooting steps**](common-drawing-troubleshooting-steps.md); these should resolve things most of the time. If that doesn't work, contact support.
...
* See what happens with Windows PNP drivers instead of the manufacturer drivers: [DIAG: Testing with Windows PNP drawing tablet drivers](diag-testing-with-windows-pnp-drawing-tablet-drivers.md)
