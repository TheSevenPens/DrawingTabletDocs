...
* [Guides](guides/README.md)
  ...
  * [Ergonomics](guides/ergonomics/README.md)
    * [Body posture when using drawing tablets](guides/ergonomics/body-posture-when-using-drawing-tablets.md "Body posture")
    * [Handedness of drawing tablets](guides/ergonomics/handedness-of-drawing-tablets.md "Handedness")
    * [Using a drawing tablet in portrait mode](guides/ergonomics/using-a-drawing-tablet-in-portrait-mode.md " Portrait mode")
    ...
    * [Using a drawing tablet on your lap](guides/ergonomics/using-a-drawing-tablet-on-your-lap.md " On your lap")
    * [Using a drawing tablet in bed](guides/ergonomics/using-a-drawing-tablet-in-bed.md "In bed")
