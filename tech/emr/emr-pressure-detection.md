...
Their difference is in the mechanism used for pressure detection.
...
The **very old technique:** The nib goes into the hollow ferrite rod but does not come out the other side. The nib is shaped in such a way that it is firmly embedded in the ferrite rod. As the nib moves, so too does the ferrite rod. The movement of the ferrite rod changes the resonant frequency of the inductor coil. That change in frequency is then sensed by the tablet and translated to pressure.
