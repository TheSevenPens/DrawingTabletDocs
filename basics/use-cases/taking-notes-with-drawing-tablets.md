...
Generally I believe you will get the most natural experience taking notes if you use a [standalone pen-enabled mobile computers](../../recommendations/standalone-drawtablet-recs/pen-enabled-mobile-devices.md) or [**dedicated note taking devices**](../../recommendations/scenarios/note-taking-recs.md). Because both these kinds of devices have screens, are portable, and don't require a computer to use. And this makes them very convenient for taking notes.
