...
Generally I believe you will get the most natural experience taking notes if you use a [Pen-enabled mobile device recommendations](../../recommendations/mobile-device-recs.md) or [Dedicated note taking devices](../../recommendations/scenario-recs/note-taking-recs.md). Because both these kinds of devices have screens, are portable, and don't require a computer to use. And this makes them very convenient for taking notes.
