...
* **Tilt**  can be very useful for for certain kinds of artwork. If you are just taking notes it may not be useful at all. Almost all modern tablets support tilt, except for less than a handful of pen tablets. More here [**tilt**](../core-features/pen-tilt.md).
