...
* Here's a list of [Common problems with drawing tablets](../troubleshooting/common-problems.md). Although for a majority of you everything \`will "just work" some small number of you will start off with issues on day one.
