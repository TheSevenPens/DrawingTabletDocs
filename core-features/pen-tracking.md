...
If your pen's position is not matching where the pointer is in a major way especially if it is happening across most of the tablet, then [**pen tracking calibration**](../guides/customizing/calibrate-pen-position-on-a-pen-display.md) may help.
