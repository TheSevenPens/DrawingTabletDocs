...
* The vast majority of drawing tablet pens are too-sensitive to small changes in physical pressure near the IAF. This means there is some [**pressure instability at low pressure**](pen-pressure-instability-at-low-pressure.md). You can address this by using [**pressure curves**](pen-pressure-curve/) or **pressure smoothing**.
