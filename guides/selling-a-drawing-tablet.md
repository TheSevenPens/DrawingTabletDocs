...
* The title should include
  ...
  * MODEL number of the tablet. See: [Finding the model number of a drawing tablet](general/finding-the-model-number-of-your-drawing-tablet.md)
...
* Take a picture of the MODEL NUMBER of the tablet. It's usually on the back. See: [Finding the model number of a drawing tablet](general/finding-the-model-number-of-your-drawing-tablet.md)
