...
Even though Windows has a built-in PNP driver for drawing tablets, it is very primitive, and you should always install the manufacturer-provided tablet drivers. For more about Windows built-in PNP drivers, see [Windows PNP support](windows-pnp-support.md).
