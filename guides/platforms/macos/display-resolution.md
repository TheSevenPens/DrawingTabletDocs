...
Especially at the 13" and 16" sizes, a 2.5K display delivers a massive increase over 2K. At these sizes, higher resolutions only provide very incremental benefits.

## My experience and recommendations

Based on my experience, here's what I think works. Overall, a PPI between 150 and 180 is what I think works best.
...
macOS text rendering can fail to look right by default with certain combinations of sizes and resolutions. This can be addressed with an app called BetterDisplay.
