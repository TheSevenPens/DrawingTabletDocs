...
This document is going to talk about connectors a lot. So you need to know what they look like first. Read this guide on [Display connector types](../../pen-displays/display-connector-types.md) before you continue.
