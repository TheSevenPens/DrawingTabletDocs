...
If you are looking for a laptop that works like a drawing tablet, go here: [Standalone: en-enabled laptop recommendations](../recommendations/standalone-pen-enabled-laptop-recommendations.md) &#x20;
...
Frist, I DO NOT recommend getting a ChromeOS laptop (aka chromebook). In my testing they do not work well with drawing tablets. See: [Connecting a drawing tablet to a ChromeOS device](operating-systems/chromeos/using-a-drawing-tablet-with-a-chromebook.md).
