# Mapping active area to a display

## Overview&#x20;

All drawing tablets need to identify which display the pointer will be on when the pen is used with a tablet. For a pen tablet users can map it usually to any display or even the virtual desktop. For a pen display, the active area will usually be mapped to the display embedded in the tablet. In both cases, sometime the mapping will be incorrect and you'll need to modify it.
