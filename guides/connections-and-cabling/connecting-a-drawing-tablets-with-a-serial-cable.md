...
Modern Wacom drivers no longer support any serial connection. However, there is an alternative. ou can use [**KuuubeTD**](https://github.com/Kuuuube/KuuubeTD). This is special driver created by tablet expert [**Kuuube**](../../resources/drawing-tablet-community/kuuube/) that allows communication with this old SD tablets that use the serial port. This is only recommended for people with deeper technical skills.
