# Finding the model number of your pen

Places to look for the model number of the pen

* On the box your tablet came in
...
* Table drivers may have diagonostics UI that reveals the pen model number. see: [DIAG: Checking tablet driver diagnostics](../../troubleshoot/diag-tablet-driver-diagnostics.md)
