...
* They bought the tablet used - for example from eBay (more here: [Buying used drawing tablets](../../buying/used-drawtabs.md))
...
* Use [Using older tablet drivers](../drivers/older-tablet-drivers.md)
...
If you wish to remove or reduce the yellowing consider using a retrobright process. More here: [Retrobright to handle yellowed plastic](../maintaining/retrobrighting.md).
