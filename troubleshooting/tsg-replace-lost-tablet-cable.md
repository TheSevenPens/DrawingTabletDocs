...
* Fits into your tablet's port.
  ...
  * Some ports in tablets are recessed - so occasionally only cables that have ends that are thin enough will fit into the port. For example, see [Recessed USB-C ports](../guides/connecting/recessed-usbc-ports.md).
* carries data
...
This situation is more complicated because there are so many different ways to connect a pen display. See [Connecting a pen display](../guides/connecting/connecting-pen-display/). And not all cables that will fit into your tablet or computer will work as expected.
