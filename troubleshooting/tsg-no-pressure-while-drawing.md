...
* See what happens with Windows PNP drivers instead of the manufacturer drivers: [Testing with Windows PNP drawing tablet drivers](diag-testing-with-windows-pnp-drawing-tablet-drivers.md)
