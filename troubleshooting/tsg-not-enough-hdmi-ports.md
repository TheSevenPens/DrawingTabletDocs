...
* If your tablet supports getting a display signal via a USB-C cable, you MIGHT be able to use that as an alternative. See: [USB-C DisplayPort alt mode](../guides/pen-displays/usbc-displayport-alt-mode.md)&#x20;
