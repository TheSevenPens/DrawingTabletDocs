...
Try adjusting the pressure curve in the driver until the problem goes away. Specifically you are looking for a pressure curve that "constrains the output". This means the right edge of the curve does not go up to the full height of the pressure curve. More here: [Pressure curves that constrain output](../core/pen-pressure/pen-pressure-curves/constraining-pressure-curve-output.md)
...
More here: [Null pressure curve](../core/pen-pressure/pen-pressure-curves/null-pressure-curve.md)
