...
For example, connect it to another computer or X-BOX or DVD player. If you see something, then it tells you that the pen display is capable of showing something but that the problem is somewhere else. More here: [Check if the pen display works with another display output device](checking-if-pen-display-shows-hdmi-video-signal-from-other-devices.md) .
