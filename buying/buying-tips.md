...
* Here's a list of [Common problems](../troubleshoot/diag-common-problems.md). Although the majority of users will have no issues, a small number will run into problems on day one.
