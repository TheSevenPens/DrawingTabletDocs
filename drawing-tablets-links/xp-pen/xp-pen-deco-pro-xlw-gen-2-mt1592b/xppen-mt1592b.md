...
This is large-sized tablet -comparable in size to the Wacom Intuos Pro Large (PTH-860).  and you should be aware about the realities of using a tablet this big: [**Using large pen tablets**](../../../guides/customizing/using-large-pen-tablets.md) &#x20;
...
It comes with XP-Pen X3 Pro pen. The shape is very close to the Wacom Pro Pen 2. It has two buttons, an eraser. It has a good pressure range. Much more here: [**XP-Pen X3 Pro pen**](../../../pen-links/xp-pen-pens/7p-xppen-x3pro-pen.md) .
...
To understand what hover jitter is, go here: [**Hover jitter**](../../../core-features/hover-jitter.md)
