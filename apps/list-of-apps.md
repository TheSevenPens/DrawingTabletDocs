...
* **HEAVYPAINT** (iOS, Android, Web) [HEAVYPAINT](../catalog/apps/heavypaint.md)
...
* **Medibang Pro** (iOS) [Medibang Pro](../catalog/apps/medibang-pro.md)
* **Microsoft Paint** (aka MSPAINT) (Windows) [Microsoft Paint](../catalog/apps/microsoft-paint.md)
* **MyPaint** (Windows, Linux) [MyPaint](../catalog/apps/mypaint.md)
...
* **PixiEditor** (Windows, MacOS, Linux) [PixiEditor](../catalog/apps/pixieditor.md)
* **pixilart** (web) [https://www.pixilart.com/](https://www.pixilart.com/)

## Sketching

* **Concepts** (Windows, Android, iOS, ChromeOS) [Concepts app](../catalog/apps/concepts-app.md)
...
* **Adobe Photoshop** (Windows, MacOS) [Photoshop](../catalog/apps/photoshop.md)
* **Photopea** (web) [https://www.photopea.com/](https://www.photopea.com/)

## Presenting

* **ZoomIt** (Windows) [ZoomIt](../catalog/apps/zoomit.md) **FREE**
