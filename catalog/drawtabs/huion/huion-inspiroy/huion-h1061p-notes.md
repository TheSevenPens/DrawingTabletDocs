...
This is one of those effects (again that all tablets have) that shows up under a specific set of circumstances and not something you will run into regularly. If you do see it there are techniques to control it: [TSG: Low pressure drawing problems](../../../../troubleshoot/tsg-strokes-quality-problems-at-low-pressure.md)
