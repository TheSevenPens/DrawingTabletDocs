...
These pens are very good in terms of pressure. Much more here: [Huion PW600 series pens](../../pens/huion-pens/huion-pw600-notes.md)
...
* **Touch on Windows**
  ...
  * If touch goes to your monitor instead of the tablet, here's how to fix it: [TSG: Touch input goes to the wrong display on Windows](../../../troubleshoot/tsg-touch-on-wrong-display-windows.md)
