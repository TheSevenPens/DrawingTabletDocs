...
The problem: Wacom makes several different devices with confusingly similar names:

**"One by Wacom"** refers to either of 2 pen tablets:

* One by Wacom Small (CTL-472) released in 2018
* One by Wacom Medium (CTL-672) released in 2018

**"Wacom One"** can refer to any of 5 drawing tablets across two generations:
